...
LOSSES = ["rc", "kl", "rcxyz", "velxyz"]
MODELTYPES = ["cvae"]
ARCHINAMES = ["fc", "gru", "transformer", "transgru", "grutrans", "autotrans"]

def add_model_options(parser):
    group = parser.add_argument_group('Model options')
    group.add_argument("--losses", default='rcxyz_kl', help="Choice of the model, should be like cvae_transformer_rc_rcxyz_kl")
    group.add_argument("--latent_dim", default=48, type=int, help="dimensionality of the latent space")
    group.add_argument("--lambda_kl", required=True, type=float, default=1e-4, help="weight of the kl divergence loss")
