...
def add_dataset_options(parser):
    ...
    group.add_argument("--dataset", required=True, default='xia', help="Dataset to load")
    ...
    group.add_argument("--pose_rep", required=True, choices=POSE_REPS, default='xyz', help="xyz or rotvec etc")
