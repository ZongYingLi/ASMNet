...
class HumanAct12Poses(Dataset):
    ...
    def __init__(self, datapath="E:\ACTOR\data\HumanAct12Poses", **kargs):
    ...
    def _load_rotvec(self, ind, frame_ix):  # frame_ix :0-60
        pose = self._pose[ind][frame_ix].reshape(-1, 24, 3)   # [60, 24, 3]
        return pose
